<template>
  <v-container>
    <v-row>
      <v-col cols="6">
        <v-text-field v-model="textInput" @keypress.enter="sendMessage()"></v-text-field>
        ...
        <v-card class="pa-4">
          <v-simple-table>
            <template v-slot:default>
              ...
              <tbody>
                <tr v-for="output in serverOutput" :key="output.text">
...
<script>
import { addEventListener, sendEvent } from "../plugins/socketio";
